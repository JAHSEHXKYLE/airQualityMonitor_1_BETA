...
#ifndef _GxEPD2_2IC_2IC_BW_H_
#define _GxEPD2_2IC_2IC_BW_H_

// uncomment next line to use class GFX of library GFX_Root instead of Adafruit_GFX
//#include <GFX.h>

#ifndef ENABLE_GxEPD2_2IC_GFX
// default is off
#define ENABLE_GxEPD2_2IC_GFX 0
#endif

#if ENABLE_GxEPD2_2IC_GFX
#include "GxEPD2_2IC_GFX.h"
#define GxEPD2_2IC_GFX_BASE_CLASS GxEPD2_2IC_GFX
#elif defined(_GFX_H_)
#define GxEPD2_2IC_GFX_BASE_CLASS GFX
#else
#include <Adafruit_GFX.h>
#define GxEPD2_2IC_GFX_BASE_CLASS Adafruit_GFX
#endif

#include "GxEPD2_2IC_EPD.h"
#include "epd/GxEPD2_2IC_420_A03.h"

template<typename GxEPD2_2IC_Type, const uint16_t page_height>
class GxEPD2_2IC_BW : public GxEPD2_2IC_GFX_BASE_CLASS
{
  public:
    GxEPD2_2IC_Type epd2;
#if ENABLE_GxEPD2_2IC_GFX
    GxEPD2_2IC_BW(GxEPD2_2IC_Type epd2_instance) : GxEPD2_2IC_GFX_BASE_CLASS(epd2, GxEPD2_2IC_Type::WIDTH, GxEPD2_2IC_Type::HEIGHT), epd2(epd2_instance)
#else
    GxEPD2_2IC_BW(GxEPD2_2IC_Type epd2_instance) : GxEPD2_2IC_GFX_BASE_CLASS(GxEPD2_2IC_Type::WIDTH, GxEPD2_2IC_Type::HEIGHT), epd2(epd2_instance)
#endif
    {
  ...
  private:
    uint8_t _buffer[(GxEPD2_2IC_Type::WIDTH / 8) * page_height];
