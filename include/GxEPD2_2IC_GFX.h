...
#ifndef _GxEPD2_2IC_GFX_H_
#define _GxEPD2_2IC_GFX_H_

// uncomment next line to use class GFX of library GFX_Root instead of Adafruit_GFX
//#include <GFX.h>

#if defined(_GFX_H_)
#define GxEPD2_2IC_GFX_ROOT_CLASS GFX
#else
#include <Adafruit_GFX.h>
#define GxEPD2_2IC_GFX_ROOT_CLASS Adafruit_GFX
#endif

#include <GxEPD2_2IC_EPD.h>

class GxEPD2_2IC_GFX : public GxEPD2_2IC_GFX_ROOT_CLASS
{
  public:
    GxEPD2_2IC_GFX(GxEPD2_2IC_EPD& _epd2, int16_t w, int16_t h) : GxEPD2_2IC_GFX_ROOT_CLASS(w, h), epd2(_epd2) {};
